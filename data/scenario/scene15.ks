...
[button graphic="q14.png" x="250" target=*next2]
[s]
*next2
[cm]
@layopt layer=message0 visible=true
...
@layopt layer=message0 visible=false
[playse storage=se_maoudamashii_se_paper01.ogg volume=50 loop=false ]
[button graphic="q14.png" x="250" target=*roop3]
[s]
*hint
[cm]

#京子
「[font  color="pink" edge="black"]if文[resetfont]は()内の処理が[r]
[font  color="pink" edge="black"]true[resetfont]であれば、[l][r]
[font  color="pink" edge="black"]{}[resetfont]内の処理が実行されるものだったわね…」[p]
#
[chara_show  name="sadakazu" left="550" top="120" ]
[chara_mod  time="20" name="sadakazu" face="lauth"]
#定数
「京子君、今回は[font  color="pink" edge="black"]表示されない値[resetfont]と書いてあるね、[l][r]
ひっかからないように注意しよう！」[p]
「ところで、[font  color="pink" edge="black"]Math.random[resetfont]って[l][r]
なんだっけ？」[p]
#京子
「[font  color="pink" edge="black"]Math[resetfont]クラスの[font  color="pink" edge="black"]rondomメソッド[resetfont]は[r]
0～1未満の少数をランダムに生成することが出来ます。」[p]
「このコードでは小数点以下を[font  color="pink" edge="black"]Math.floor[resetfont]で切り捨てていますね。[l][r]
その値で配列を取得しているようです。」[p]
