...
[button graphic="q6.png" x="250" target=*next2]
[s]
*next2
[cm]
@layopt layer=message0 visible=true
...
@layopt layer=message0 visible=false
[playse storage=se_maoudamashii_se_paper01.ogg volume=50 loop=false ]
[button graphic="q6.png" x="250" target=*roop3]
[s]
*hint
[cm]
...
「えっ…先輩分かったんですか？[l][r]
うーん…」[p]
「strictモードはjavascriptにオプトオン(コード内に記載)することで[l][r]
制限をかけることができるモードでしたよね」[p]
[chara_mod  time="20" name="sadakazu" face="oteage"]
#定数
「さぁ、strictなんちゃらはさっぱりだよ…」[p]
#京子
「もう！分からないのに、分かった感じで言わないでくださいよ！」[p]
#定数
「京子君、この問題は3択だよ、[l][r]
strict、非strictだの言うと分かりにくいけど[l][r]
AとBどっちが正しいですか、という問題なんだよ」[p]
#定数
「[font  color="yellow"]もっとも適切なもの[resetfont]とか書いてあるけど、[l][r]
Aが2つでBが1つなら答えはBでしょ、[l][r]
演繹法(えんえきほう)だよ、京子君」[p]
#京子
「・・・[l][r]
なるほど、[l][r]
なんか先輩に指摘されると悔しいです」[p]
#
[chara_mod  time="100" name="sadakazu" face="lauth"]
[wait time="1000"]
