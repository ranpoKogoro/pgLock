...
[button graphic="q11.png" x="250" target=*next2]
[s]
*next2
[cm]
@layopt layer=message0 visible=true
...
@layopt layer=message0 visible=false
[playse storage=se_maoudamashii_se_paper01.ogg volume=50 loop=false ]
[button graphic="q11.png" x="250" target=*roop3]
[s]
*hint
[cm]

#京子
「[font  color="pink" edge="black"]console.log();[resetfont]内は、[l][r]
左から処理されるわね…」[p]
「一番左の[font  color="pink" edge="black"]数値の計算[resetfont]は実行されるけど、[l][r]
右は[font  color="pink" edge="black"]文字列[resetfont]だから…」[p]
#
@layopt layer=message0 visible=false
@jump target=*roop3
[s]
