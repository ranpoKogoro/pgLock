...
[button graphic="q10.png" x="250" target=*next2]
[s]
*next2
[cm]
@layopt layer=message0 visible=true
...
@layopt layer=message0 visible=false
[playse storage=se_maoudamashii_se_paper01.ogg volume=50 loop=false ]
[button graphic="q10.png" x="250" target=*roop3]
[s]
*hint
[cm]
...
#京子
「文字列を+で連結しているから、[l][r]
[font  color="pink" edge="black"]console.log();[resetfont]内のnumAは[l][r]
代入した値が連結される時に文字列に置き換わるわね…」[p]
#
@layopt layer=message0 visible=false
@jump target=*roop3
[s]
