...
[button graphic="q13.png" x="250" target=*next2]
[s]
*next2
[cm]
@layopt layer=message0 visible=true
...
@layopt layer=message0 visible=false
[playse storage=se_maoudamashii_se_paper01.ogg volume=50 loop=false ]
[button graphic="q13.png" x="250" target=*roop3]
[s]
*hint
[cm]

#京子
「[font  color="pink" edge="black"]配列[resetfont]が使われているわね、[l][r]
[font  color="pink" edge="black"].length[resetfont]で配列の長さを取得しているから…」[p]
「その分処理が実行されているはず…」[p]
#
@layopt layer=message0 visible=false
@jump target=*roop3
