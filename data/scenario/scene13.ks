...
[wait time="1000"]
[bg storage="Staircase2.jpg" method="slide" time="1000"]
[wait time="1000"]
...
大企業のくせに…」[p]
#京子
「うわぁ…ちょっと乾いて[font color="pink"]粘土みたいにべとべと[resetfont]してますよぉ[l][r]
買ったばかりのスニーカーが汚れちゃう…」[p]
#定数
「こりゃ避けて通るのは難しそうだね、[l][r]
ドンマイ、京子君。」[p]
#京子
「うぅ…」[p]
#
...
どうしたんだい」[p]
#京子
「さっきのコーヒー踏んじゃったせいで、[l][r]
廊下に[font  color="pink" edge="black"]足跡[resetfont]がついちゃってるんです。」[p]
#
...
[button graphic="q12.png" x="250" target=*next2]
[s]
*next2
[cm]
@layopt layer=message0 visible=true
...
[font  color="yellow" edge="black"][link storage="lookBack.ks"]振り返る[endlink][resetfont][r]
[s]
*check
[cm]
@layopt layer=message0 visible=false
[playse storage=se_maoudamashii_se_paper01.ogg volume=50 loop=false ]
[button graphic="q12.png" x="250" target=*roop3]
[s]
*hint
[cm]
#京子
「繰り返し処理に利用する[r]
[font  color="yellow"]for文[resetfont]が[r]
使われているわね…」[p]
#
[chara_show  name="sadakazu" left="550" top="120" ]
[chara_mod  time="20" name="sadakazu" face="lauth"]
...
#京子
「なるほど[l][r]
[font  color="yellow"]for文[resetfont]で[r]
何回加算されているかが重要ですね」[p]
#
[chara_hide name="sadakazu" time="100"]
@layopt layer=message0 visible=false
