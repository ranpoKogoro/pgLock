...
[button graphic="q5.png" x="250" target=*next2]
[s]
*next2
[cm]
@layopt layer=message0 visible=true
...
@layopt layer=message0 visible=false
[playse storage=se_maoudamashii_se_paper01.ogg volume=50 loop=false ]
[button graphic="q5.png" x="250" target=*roop3]
[s]
*hint
[cm]
#
...
#京子
「さだかず先輩。たしか、constとletはES6からでしたよね？」[p]
[chara_mod  time="20" name="sadakazu" face="aseri"]
#定数
「varとかletとか苦手なんだよね…なんというか、[l][r]
それを聞くとゾクっとするんだよ[l][r]
自分を否定されるような…」[p]
#京子
もしかして…[l][r]
...
[button graphic="rKeyo.png" enterimg="rKey.png" x="620" y="450" enterse="cursor2.ogg" clickse="decision7.ogg" target=*gogogo3]
[s]
