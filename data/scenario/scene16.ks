...
[button graphic="q15.png" x="250" target=*next2]
[s]
*next2
[cm]
@layopt layer=message0 visible=true
...
@layopt layer=message0 visible=false
[playse storage=se_maoudamashii_se_paper01.ogg volume=50 loop=false ]
[button graphic="q15.png" x="250" target=*roop3]
[s]
*hint
[cm]

#京子
「[font  color="pink" edge="black"]アロー関数()=>{};[resetfont]が使われてますね…[l][r]
[font  color="pink" edge="black"]引数[resetfont]はwhoとhow、[l][r]
moment();で呼び出しているから…[p]
ぶつぶつ…[p]
ぶつぶつ…」[p]
#
